...
describe("Modulo tests", () => {
  ...
  test('integer and 0', () => {
    ...
    let numberOne = int1
    let numberTwo = zero
      expect(calculate(selectedOperator, numberOne, numberTwo)).toBe('can not do Modulo by 0');
    });
  ...
  test('2 decimal', () => {
    ...
    let numberOne = decimal1
    let numberTwo = decimal2
      expect(calculate(selectedOperator, numberTwo, numberOne)).toBe(0.20000000000000018);
    });
